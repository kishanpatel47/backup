...
import Medicine_list from './pages/Dashboard/Medicine_list';
import Store_list from './pages/Store_list';
    ...
    return (
        <NavigationContainer >
            <Stack.Navigator initialRouteName='Splashscreen'>
                ...
                <Stack.Screen name='demo' component={demo} options={{ headerShown: true }}></Stack.Screen>
                ...
                <Stack.Screen name='Medicine_list' component={Medicine_list} options={{
                    title: 'Medicine list',
                    headerRight: () => (
                        <Image style={{ height: 35, width: 35, alignItems: 'flex-end', right: 5, resizeMode: 'center' }} source={require('../src/assets/images/Dashboarddrawericons/ashokstambh.png')} />
                ...
                <Stack.Screen name='Store_list' component={Store_list}
